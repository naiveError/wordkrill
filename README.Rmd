...
Wordkrill fits Wordkrill models (generalisation of Wordfish models to multiple 
dimensions) to document-feature matrices. For additional information, see 
Riesch (2025): 'Wordkrill: Extending Wordfish into the multidimensional 
political space'. <https://arxiv.org/abs/2506.20275>.
...
(included in the `quanteda.textmodels` package), demonstrates the use of the package.
...
Alternatively, the application can also be visualised using simulated data:
